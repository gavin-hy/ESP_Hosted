...
C_SRCS += \
../host/stm32/port/platform_wrapper.c 

OBJS += \
./host/stm32/port/platform_wrapper.o 

C_DEPS += \
./host/stm32/port/platform_wrapper.d 


# Each subdirectory must supply rules for building sources it contributes
host/stm32/port/%.o host/stm32/port/%.su host/stm32/port/%.cyclo: ../host/stm32/port/%.c host/stm32/port/subdir.mk
...
clean: clean-host-2f-stm32-2f-port

clean-host-2f-stm32-2f-port:
	-$(RM) ./host/stm32/port/platform_wrapper.cyclo ./host/stm32/port/platform_wrapper.d ./host/stm32/port/platform_wrapper.o ./host/stm32/port/platform_wrapper.su

.PHONY: clean-host-2f-stm32-2f-port
